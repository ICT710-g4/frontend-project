...
#CONSTANTS
API_URL = 'http://taist-2020-heroku.herokuapp.com/api/sensor_data?device_id=1&limit=1'
...
def event_data():
    def post_data():
        ...
        for num in range(1,10):
            API_URL = f"http://taist-2020-heroku.herokuapp.com/api/sensor_data?device_id={num}&limit=1"
